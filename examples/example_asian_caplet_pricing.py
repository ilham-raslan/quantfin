...
from quantfin.instruments.caplet_3m_asian import Caplet3MAsian
...
caplet3m_asian = Caplet3MAsian(1, 0.008, 100)
caplet3m_asian = caplet3m_asian.price(ois_curve, ibor3m_curve, caplet3m_vol_surface)
print("1y caplet with strike 0.008 and notional 100 cost " + str(caplet3m_asian))
